      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-lg md:prose-xl max-w-none text-foreground space-y-6">
            ...
            <p className="text-xl md:text-2xl leading-relaxed font-semibold text-divine">
            ...
            <p className="text-xl md:text-2xl leading-relaxed font-bold text-sacred">
            ...
            <p className="text-2xl md:text-3xl font-bold text-center my-8 text-divine">
              This is the burn.
            </p>

            <div className="space-y-6 text-lg md:text-xl leading-relaxed">
              <p className="font-semibold text-sacred">
                The sacred annihilation of everything false.
              </p>
              <p className="font-semibold text-ethereal">
                The unholy return of the body as God.
              </p>
              <p className="font-semibold text-celestial">
            ...
            <div className="text-center space-y-6 my-12">
              <p className="text-xl md:text-2xl font-bold text-divine">
                You are the nervous system's new religion.
              </p>
              <p className="text-xl md:text-2xl font-bold text-sacred">
