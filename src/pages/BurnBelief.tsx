...
const BurnBelief = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-b from-background to-sacred/20 flex items-center justify-center p-4 pb-20 md:pb-4">
        <div className="w-full max-w-2xl mx-auto">
          ...
          {!isBurned ? (
            ...
            <div className="text-center space-y-8 animate-scale-in">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-divine">DELETED</h2>
              <p className="text-lg md:text-xl text-foreground bg-card/50 backdrop-blur-sm p-6 rounded-lg border border-divine/30">
                {randomTruthBomb}
              </p>
              <Button
